 ...
 * Use lucide's Mail, Phone, Globe, MapPin, Facebook, Instagram, Linkedin,
 * Twitter, Github for the rest — these match the same line-icon style.
 */
...
/* Official brand glyphs (Simple Icons paths) — fill="currentColor". */
