      ...
      <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 z-10 relative">
        {testimonials.map((t, i) => (
          <motion.div
            ...
            className={cn(
              "group relative flex h-full flex-col overflow-hidden rounded-3xl border border-zinc-200/50 dark:border-zinc-800/50 bg-white/40 dark:bg-zinc-900/40 p-8 shadow-lg hover:shadow-2xl hover:shadow-blue-600/[0.01]",
          ...
          >
            ...
            <span
              aria-hidden="true"
              className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-blue-600 via-emerald-500 to-sky-500 opacity-0 transition-opacity duration-500 group-hover:opacity-100"
            />
            
            {/* Quote Icon */}
            <div className="mb-6 text-blue-600/35 dark:text-blue-400/25 group-hover:text-blue-600 dark:group-hover:text-blue-400 group-hover:scale-110 transition-all duration-500 self-start">
            ...
            <figcaption className="mt-6 flex items-center gap-3.5 border-t border-zinc-150 dark:border-zinc-800/60 pt-5 sm:mt-8 sm:pt-6">
              ...
              <div className="p-[2px] rounded-full bg-gradient-to-tr from-blue-600 to-emerald-500 group-hover:rotate-6 transition-transform duration-500">
                <span
                  aria-hidden="true"
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="line-clamp-2 break-words text-xs text-zinc-500 dark:text-zinc-400 font-semibold sm:line-clamp-1">
                  {t.role} · <span className="text-blue-600 dark:text-blue-400">{t.location}</span>
                </p>
              </div>
            </figcaption>
          </motion.div>
