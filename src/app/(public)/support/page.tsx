      ...
      <div className="container-app relative z-10 space-y-16">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-6">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-violet-600 to-emerald-500 bg-clip-text text-transparent">vous aider ?</span>
          </motion.h1>
          ...
          >
            ...
            <input
              ...
              className="w-full h-14 pl-12 pr-6 rounded-2xl bg-white/50 dark:bg-zinc-900/50 border border-zinc-200/50 dark:border-zinc-800/50 focus:border-violet-500/50 focus:ring-2 focus:ring-violet-500/10 text-base font-semibold outline-none transition-all placeholder:text-zinc-400 shadow-lg"
            />
          </motion.div>
        </div>
              ...
              return (
                <motion.button
                  ...
                  className={`p-6 rounded-3xl border flex flex-col items-center text-center gap-3 transition-all duration-300 ${
                    isActive
                      ? "bg-violet-600 text-white shadow-xl shadow-violet-600/20 border-violet-600"
                      : "bg-white/40 dark:bg-zinc-900/40 border-zinc-200/50 dark:border-zinc-800/50 text-zinc-600 dark:text-zinc-400 hover:border-violet-500/30"
                  }`}
                >
                  <div className={`p-3 rounded-2xl ${isActive ? "bg-white/20 text-white" : "bg-violet-500/10 text-violet-600"}`}>
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="w-full p-6 text-left flex items-center justify-between gap-4 font-black text-zinc-900 dark:text-zinc-50 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
                      >
                        <span className="text-base leading-tight">{faq.question}</span>
                        <ChevronDown className={`h-5 w-5 text-zinc-400 shrink-0 transition-transform duration-300 ${isExpanded ? "rotate-180 text-violet-500" : ""}`} />
                      </button>
        ...
        {/* --- Help Channels Footer Cards --- */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto pt-8">
          <div className="p-8 rounded-3xl bg-gradient-to-tr from-violet-600/10 to-indigo-500/10 border border-violet-500/20 backdrop-blur-xl flex flex-col justify-between space-y-6">
            <div className="space-y-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-violet-600/10 text-violet-600 dark:text-violet-400 shadow-inner">
          ...
          <div className="p-8 rounded-3xl bg-gradient-to-tr from-emerald-600/10 to-teal-500/10 border border-emerald-500/20 backdrop-blur-xl flex flex-col justify-between space-y-6">
            <div className="space-y-3">
