    ...
    <div className="relative pt-32 pb-24 overflow-hidden">
      ...
      <div className="container-app relative z-10 space-y-24">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-6">
          ...
          >
            Digitaliser le commerce pour <span className="bg-gradient-to-r from-orange-600 via-orange-500 to-emerald-500 bg-clip-text text-transparent">libérer le potentiel</span> africain.
          </motion.h1>
