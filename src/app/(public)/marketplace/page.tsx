      ...
      <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {boutiques.map((boutique) => (
          <Link key={boutique.id} href={`/s/${boutique.slug}`} className="group flex">
            <div className="w-full relative flex flex-col p-7 rounded-[2.5rem] border border-slate-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm hover:shadow-2xl hover:border-orange-500/30 hover:-translate-y-2.5 transition-all duration-500 ease-out overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div className="flex-1 space-y-3">
                  <div className="flex items-center gap-1.5 min-w-0">
                    <h3 className="text-xl font-black tracking-tight text-slate-800 dark:text-zinc-100 truncate group-hover:text-orange-500 transition-colors">
                      {boutique.nom}
                    </h3>
                    <CheckCircle2 className="w-4.5 h-4.5 text-orange-500 shrink-0 fill-orange-500/10" />
                  </div>
                  {boutique.adresse && (
    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0a0a0a] py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-16 sm:space-y-24">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-6 relative">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-orange-500/10 border border-orange-500/20 px-4 py-1.5 text-xs font-extrabold text-orange-500 uppercase tracking-widest relative z-10 animate-fade-in">
