...
function getActionIcon(action: string) {
  ...
  if (normalized.includes("delete") || normalized.includes("remove") || normalized.includes("supprim")) {
    return { icon: ShieldAlert, color: "text-red-600 bg-red-50 dark:text-red-400 dark:bg-red-950/30 border-red-200/50 dark:border-red-900/30" };
  }
          ...
          {filteredLogs.length === 0 ? (
            ...
            >
              <div className="relative mb-5">
                ...
                <div className="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-zinc-100 dark:bg-zinc-800 text-zinc-500 shadow-md">
            ...
            filteredLogs.map((log, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`absolute -left-[49px] top-1 flex h-10 w-10 items-center justify-center rounded-xl border shadow-md backdrop-blur-md dark:bg-zinc-900 ${audit.color} transition-all duration-300 group-hover:scale-110`}>
                  ...
                  <div
                    ...
                    className="cursor-pointer rounded-3xl border border-zinc-200/50 bg-white/70 p-5 shadow-sm backdrop-blur-md dark:border-white/10 dark:bg-zinc-900/70 transition-all duration-300 hover:shadow-lg hover:bg-white/95 dark:hover:bg-zinc-900/95 hover:border-orange-500/30"
                  >
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                      <div className="space-y-1">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <Badge variant="outline" className="text-[9px] font-black tracking-widest uppercase px-2 py-0.5 rounded-lg border-zinc-200 text-zinc-500 dark:border-zinc-700 dark:text-zinc-400">
                      ...
                      <div className="text-left sm:text-right space-y-1.5 shrink-0">
                        ...
                        <div className="flex items-center sm:justify-end gap-2">
                          {log.ipAddress && (
                            <span className="inline-flex items-center gap-1 text-[9px] font-bold text-zinc-400 font-mono bg-zinc-100 dark:bg-zinc-800/50 px-2 py-0.5 rounded-md">
                    ...
                    <AnimatePresence>
                      {isExpanded && (
                        <motion.div
                          ...
                          className="mt-4 pt-4 border-t border-zinc-100 dark:border-zinc-800 space-y-3 cursor-default"
                        >
                          {log.subjectId && (
                            <div className="flex items-center gap-2 rounded-xl bg-zinc-100/40 p-2.5 dark:bg-zinc-800/30 border border-zinc-200/10">
