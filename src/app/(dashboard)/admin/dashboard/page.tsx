  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-violet-100 bg-gradient-to-br from-violet-50/80 to-white/90 p-6 shadow-md backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-violet-950/30 dark:from-violet-950/20 dark:to-zinc-950/75">
          <div className="absolute -right-8 -top-8 h-24 w-24 rounded-full bg-violet-600/10 blur-xl" />
          <div className="flex items-center justify-between">
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-violet-600 text-white shadow-[0_0_12px_rgba(124,58,237,0.3)] dark:bg-violet-500">
              <Wallet className="h-5 w-5" />
            </div>
          </div>
          <div className="mt-4">
            <h2 className="text-3xl font-extrabold tracking-tight text-violet-950 dark:text-violet-50">
      ...
      <div className="grid gap-6 grid-cols-2 md:grid-cols-3">
        <div className="group rounded-2xl border border-zinc-200/50 bg-white p-5 shadow-sm transition-all duration-200 hover:shadow-md dark:border-zinc-800/50 dark:bg-zinc-950">
          <div className="flex items-center space-x-2.5">
            <div className="rounded-lg bg-zinc-100 p-2 dark:bg-zinc-900 group-hover:bg-violet-50 dark:group-hover:bg-violet-950/30 transition-colors">
              <Package className="h-4 w-4 text-zinc-500 group-hover:text-violet-600 transition-colors" />
            </div>
              ...
              stats.vendeursRecents.map((vendeur) => (
                ...
                >
                  <div className="flex items-center space-x-3.5">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-indigo-600 text-white font-bold text-sm shadow-[0_4px_12px_rgba(124,58,237,0.15)]">
                ...
                >
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                        Plan <span className="font-semibold text-violet-600 dark:text-violet-400">{p.abonnement.plan.nom}</span> • {p.methode}
                      </p>
                    </div>
                  </div>
      ...
      <div className="rounded-2xl border border-zinc-200/50 bg-white p-6 shadow-lg shadow-zinc-100/40 dark:border-zinc-800/50 dark:bg-zinc-950 dark:shadow-none">
        <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          <div className="flex items-center space-x-3">
            <div className="rounded-xl bg-violet-50 p-2.5 dark:bg-violet-950/30">
          ...
          <Link
            href="/admin/logs"
            className="inline-flex items-center gap-1 rounded-lg bg-violet-50 px-3 py-1.5 text-xs font-semibold text-violet-700 hover:bg-violet-100 dark:bg-violet-950/30 dark:text-violet-300 dark:hover:bg-violet-950/50"
          >
            ...
            stats.logsRecents.map((log) => (
              <div key={log.id} className="flex items-start justify-between py-4 group">
                <div className="space-y-1">
                  <p className="text-xs font-semibold text-zinc-950 dark:text-zinc-50 group-hover:text-violet-600 transition-colors">
                    {log.action}
                  </p>
