            ...
            <Tooltip
              content={({ active, payload }) => {
                if (active && payload && payload.length > 0) {
                  ...
                  return (
                    <div className="rounded-xl border border-slate-200/80 bg-white/95 p-3.5 shadow-xl shadow-slate-200/40 backdrop-blur-md dark:border-slate-800/80 dark:bg-slate-950/95 dark:shadow-none min-w-[200px]">
                      <p className="text-xs font-bold text-slate-950 dark:text-slate-50 mb-3 border-b border-slate-100 dark:border-slate-800 pb-2">
