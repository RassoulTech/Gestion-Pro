      ...
      <AnimatePresence mode="wait">
        {filteredAbonnements.length === 0 ? (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="flex flex-col items-center justify-center p-6 sm:p-12 rounded-3xl border border-dashed border-zinc-200 bg-white/30 backdrop-blur-sm dark:border-dashed dark:border-zinc-800/80 dark:bg-zinc-900/15 text-center min-h-[280px] sm:min-h-[350px]"
          >
                ...
                >
                  ...
                  <div className="mt-4 space-y-2 border-t border-zinc-100 pt-3 dark:border-zinc-800 text-xs">
                    <div className="flex justify-between items-center">
                      <span className="text-zinc-500 flex items-center gap-1 font-semibold"><Sparkles className="h-3 w-3" /> Offre</span>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-zinc-500 flex items-center gap-1 font-semibold"><Calendar className="h-3 w-3" /> Début</span>
                      <span className="font-semibold text-zinc-700 dark:text-zinc-300">{formatDate(a.dateDebut)}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-zinc-500 flex items-center gap-1 font-semibold"><Calendar className="h-3 w-3" /> Fin</span>
                      <span className="font-semibold text-zinc-500 dark:text-zinc-400">
                        {a.dateFin ? formatDate(a.dateFin) : <span className="text-zinc-400 font-mono">—</span>}
                      </span>
                    </div>
                    <div className="flex justify-between items-center pt-2 border-t border-zinc-100 dark:border-zinc-800">
                      <span className="text-zinc-500 font-bold">Montant</span>
