        ...
        <div className="relative flex flex-col gap-4">
          <div className="flex flex-col gap-4 md:flex-row md:items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex rounded-xl bg-zinc-100 p-1 dark:bg-zinc-800/50">
                <button
            ...
            <div className="grid gap-4 md:hidden">
              {filteredBoutiques.map((b) => {
                ...
                return (
                  <div
                    key={b.id}
                    className="relative overflow-hidden rounded-2xl border border-zinc-200/50 bg-white/70 p-5 shadow-md backdrop-blur-md dark:border-white/10 dark:bg-zinc-900/50 hover:shadow-lg hover:border-orange-500/30 transition-all duration-300 animate-in fade-in duration-200"
                  >
                    ...
                    <div className="mt-4 space-y-2 border-t border-zinc-100 pt-3 dark:border-zinc-800 text-xs">
                      <div className="flex justify-between items-center">
                        <span className="text-zinc-500 flex items-center gap-1 font-semibold"><User className="h-3 w-3" /> Propriétaire</span>
                        <span className="font-semibold text-zinc-700 dark:text-zinc-300">{b.vendeur.prenom} {b.vendeur.nom}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-zinc-500 flex items-center gap-1 font-semibold"><Tag className="h-3 w-3" /> Secteur</span>
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-zinc-500 flex items-center gap-1 font-semibold"><Package className="h-3 w-3" /> Produits</span>
                        <span className="font-extrabold text-zinc-800 dark:text-zinc-200">{b._count.produits}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-zinc-500 flex items-center gap-1 font-semibold"><Calendar className="h-3 w-3" /> Créée le</span>
                        <span className="font-semibold text-zinc-500 dark:text-zinc-400">{formatDate(b.createdAt)}</span>
                      </div>
                    </div>

                    <div className="mt-4 flex justify-end gap-2 pt-3 border-t border-zinc-100 dark:border-zinc-800">
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell className="py-4 text-center font-extrabold text-zinc-800 dark:text-zinc-200">
                            <span className="inline-flex items-center justify-center min-w-7 h-5 px-2 rounded-lg bg-zinc-100 dark:bg-zinc-800 text-xs font-bold">
                              {b._count.produits}
                            </span>
                          </TableCell>
