      ...
      <AnimatePresence mode="wait">
        {filteredBoutiques.length === 0 ? (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="flex flex-col items-center justify-center p-12 rounded-[2.5rem] border border-dashed border-zinc-200 bg-white/30 backdrop-blur-sm dark:border-zinc-800/80 dark:bg-zinc-950/15 text-center min-h-[350px]"
          >
            ...
            <div className="grid gap-4 md:hidden">
              {filteredBoutiques.map((b) => {
                ...
                return (
                  <div
                    key={b.id}
                    className="relative overflow-hidden rounded-[2rem] border border-zinc-200/50 bg-white/70 p-5 shadow-md backdrop-blur-md dark:border-zinc-800/50 dark:bg-zinc-950/70 hover:shadow-lg transition-all duration-300 animate-in fade-in duration-200"
                  >
