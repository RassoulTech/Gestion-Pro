                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-4 space-y-2 border-t border-zinc-100 pt-3 dark:border-zinc-800 text-xs">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-zinc-500 flex items-center gap-1 font-semibold"><Store className="h-3 w-3" /> Boutiques</span>
                    ...
                    <div className="mt-4 flex flex-wrap justify-end gap-2 pt-3 border-t border-zinc-100 dark:border-zinc-800">
                          ...
                          <TableCell className="py-4 font-semibold text-zinc-950 dark:text-zinc-50 pl-6">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <span className="text-[10px] font-semibold text-zinc-500 dark:text-zinc-400">ID: {v.id.slice(0, 8)}</span>
                              </div>
                            </div>
                          </TableCell>
