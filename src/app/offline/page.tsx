  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-background px-6 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl font-black tracking-tight">Vous êtes hors ligne</h1>
        <p className="max-w-sm text-sm font-medium text-muted-foreground">
          Impossible de joindre GestionPro pour le moment. Vérifiez votre connexion — la page se
          rechargera dès le retour du réseau.
        </p>
      </div>
